...
class EmbedDeleteFieldEdit : ListenerAdapter() {
    override fun onStringSelectInteraction(event: StringSelectInteractionEvent) {
        if(event.values[0] != "embedEdit.selectMenu.deleteField") { return }
        ...
        val stringSelectMenu = StringSelectMenu.create("embedDeleteField.selectFieldMenu.edit")
