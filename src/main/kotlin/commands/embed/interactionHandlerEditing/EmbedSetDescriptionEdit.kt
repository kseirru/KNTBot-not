...
class EmbedSetDescriptionEdit  : ListenerAdapter() {
    override fun onStringSelectInteraction(event: StringSelectInteractionEvent) {
        if(event.values[0] != "embedEdit.selectMenu.setDescription") { return }
        ...
        val modal = ModalBuilder("embedEdit.embedSetDescription.modal", tr.get("embedSetDescription.modal.title"))
    ...
    override fun onModalInteraction(event: ModalInteractionEvent) {
        if(event.modalId != "embedEdit.embedSetDescription.modal") { return }
