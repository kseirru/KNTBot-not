...
class EmbedAddFieldEdit  : ListenerAdapter() {
    override fun onStringSelectInteraction(event: StringSelectInteractionEvent) {
        if(event.values[0] != "embedEdit.selectMenu.addField") { return }
        ...
        val modal = ModalBuilder("embedEdit.embedAddField.modal", tr.get("embedAddField.modal.title"))
    ...
    override fun onModalInteraction(event: ModalInteractionEvent) {
        if(event.modalId != "embedEdit.embedAddField.modal") { return }
